...
describe("store", () => {
    ...
    beforeEach(() => {
        ...
        workersRunner = {
            readDump: jest.fn().mockImplementation((dumpPath: string) => {
                const mockFileName = "uGDzURz0KxqgW7PWISZksQ";
    ...
    describe("dumpsDir", () => {
        it("should read dumps from dumpsDir as string", async () => {
            ...
            const dumpPath = path.resolve(process.cwd(), "specified", "uGDzURz0KxqgW7PWISZksQ") + ".json";
        ...
        it("should read dumps from dumpsDir as function", async () => {
            ...
            const dumpPath = path.resolve("fullTitle", "uGDzURz0KxqgW7PWISZksQ") + ".json";
            expect(workersRunner.readDump).toBeCalledWith(dumpPath);
        });
    });
